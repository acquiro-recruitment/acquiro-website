...
})(["display:flex;flex:1 1 25rem;flex-direction:column;order:", ";margin:", ";overflow:hidden;border-radius:0 0 0.625rem 0.625rem;box-shadow:0 2.1875rem 6.25rem 0 rgba(31,2,89,0.1);transition:all 0.2s ease-in-out;&:hover{text-decoration:none;color:inherit;transform:translateY(-0.125rem);box-shadow:0 2.1875rem 5rem 1.25rem rgba(31,2,89,0.1);}@media (min-width:", "){flex:", ";flex-direction:", ";border-radius:", ";}"], ({
  featured
}) => featured ? "-1" : "0", ({
  noMargin
...
})(["width:100%;height:15.625rem;transition:transform 0.2s ease-in-out;img{height:15.625rem;}@media (min-width:", "){height:", ";img{height:", ";}}"], _styles_theme__WEBPACK_IMPORTED_MODULE_3__["default"].breakpoints.s, ({
  featured
}) => featured ? "22.5rem" : "15.625rem", ({
  featured
}) => featured ? "22.5rem" : "15.625rem");
...
})(["margin:0 0 1.25rem;font-size:1.15rem;@media (min-width:", "){margin:", ";font-size:", ";}"], _styles_theme__WEBPACK_IMPORTED_MODULE_3__["default"].breakpoints.s, ({
  featured
...
})(["margin:1rem 0;font-size:1rem;font-weight:500;color:", ";@media (min-width:", "){padding-bottom:2rem;}"], _styles_theme__WEBPACK_IMPORTED_MODULE_3__["default"].colors.black, _styles_theme__WEBPACK_IMPORTED_MODULE_3__["default"].breakpoints.s);
