...
})(["margin-top:0;margin-bottom:18px;font-weight:900;font-size:32px;line-height:36px;letter-spacing:-0.8px;@media (min-width:", "){margin-bottom:38px;font-size:56px;line-height:60px;letter-spacing:-1.8px;}@media (min-width:", "){margin-bottom:64px;font-size:72px;line-height:72px;letter-spacing:-2px;}"], ({
  theme
}) => theme.breakpoints.s, ({
  theme
}) => theme.breakpoints.l);
