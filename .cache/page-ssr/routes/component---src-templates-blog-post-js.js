...
})(["width:", ";margin-right:", ";height:auto;border-radius:100%;border:", ";"], ({
  small
}) => small ? "2.25rem" : "4rem", ({
  small
}) => small ? "0.85rem" : "1.25rem", ({
  small
}) => small ? "none" : `3px solid ${_styles_theme__WEBPACK_IMPORTED_MODULE_1__["default"].colors.primary}`);
...
/* harmony import */ var _styles_wordpress_block_library_build_style_style_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../styles/@wordpress/block-library/build-style/style.css */ "./src/styles/@wordpress/block-library/build-style/style.css");
/* harmony import */ var _styles_wordpress_block_library_build_style_style_css__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_styles_wordpress_block_library_build_style_style_css__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _styles_wordpress_block_library_build_style_theme_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../styles/@wordpress/block-library/build-style/theme.css */ "./src/styles/@wordpress/block-library/build-style/theme.css");
/* harmony import */ var _styles_wordpress_block_library_build_style_theme_css__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_styles_wordpress_block_library_build_style_theme_css__WEBPACK_IMPORTED_MODULE_8__);
...
const BlogPostTemplate = ({
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("article", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PostHeading, null, (0,html_react_parser__WEBPACK_IMPORTED_MODULE_3__["default"])(post.title)), (featuredImage === null || featuredImage === void 0 ? void 0 : featuredImage.data) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_9__.GatsbyImage, {
    image: featuredImage.data,
    alt: featuredImage.alt,
    style: {
      marginBottom: 50
    }
  })), !!post.content && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PostContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    itemProp: "articleBody"
  }, (0,html_react_parser__WEBPACK_IMPORTED_MODULE_3__["default"])(post.content)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_bio__WEBPACK_IMPORTED_MODULE_4__["default"], {
    author: post.author.node
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PostNav, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, previous && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
    to: previous.uri,
    rel: "prev"
  }, "\u2190 ", (0,html_react_parser__WEBPACK_IMPORTED_MODULE_3__["default"])(previous.title))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      textAlign: "right"
    }
  }, next && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
    to: next.uri,
    rel: "next"
  }, (0,html_react_parser__WEBPACK_IMPORTED_MODULE_3__["default"])(next.title), " \u2192"))));
};

const pageQuery = "2231185670";
const PostContainer = styled_components__WEBPACK_IMPORTED_MODULE_10__["default"].div.withConfig({
  displayName: "blog-post__PostContainer"
})(["padding:0 2.5rem;"]);
const PostHeading = styled_components__WEBPACK_IMPORTED_MODULE_10__["default"].h1.withConfig({
  displayName: "blog-post__PostHeading"
})(["margin-top:2rem;margin-bottom:1.125rem;font-weight:900;font-size:2rem;line-height:2rem;letter-spacing:-0.05em;@media (min-width:", "){margin-bottom:2.375rem;font-size:3.5rem;line-height:3.75rem;letter-spacing:-0.01em;}@media (min-width:", "){margin-bottom:4rem;font-size:4.5rem;line-height:4.5rem;letter-spacing:-0.025em;}"], _styles_theme__WEBPACK_IMPORTED_MODULE_2__["default"].breakpoints.s, _styles_theme__WEBPACK_IMPORTED_MODULE_2__["default"].breakpoints.l);
const PostNav = styled_components__WEBPACK_IMPORTED_MODULE_10__["default"].nav.withConfig({
  displayName: "blog-post__PostNav"
})(["display:flex;align-items:center;justify-content:space-between;padding-top:4rem;padding-bottom:4rem;gap:2rem;@media (min-width:", "){}"], _styles_theme__WEBPACK_IMPORTED_MODULE_2__["default"].breakpoints.s);
...
/***/ "./src/styles/@wordpress/block-library/build-style/style.css":
/*!*******************************************************************!*\
  !*** ./src/styles/@wordpress/block-library/build-style/style.css ***!
  \*******************************************************************/
/***/ (() => {
...
/***/ "./src/styles/@wordpress/block-library/build-style/theme.css":
/*!*******************************************************************!*\
  !*** ./src/styles/@wordpress/block-library/build-style/theme.css ***!
  \*******************************************************************/
/***/ (() => {
